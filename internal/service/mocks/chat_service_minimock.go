...
//go:generate minimock -i github.com/ArturSaga/chat-server/internal/service.ChatService -o chat_service_minimock.go -n ChatServiceMock -p mocks
...
func (mmDeleteChat *mChatServiceMockDeleteChat) Set(f func(ctx context.Context, id int64) (ep1 *emptypb.Empty, err error)) *ChatServiceMock {
	if mmDeleteChat.defaultExpectation != nil {
...
func (mmDeleteChat *ChatServiceMock) DeleteChat(ctx context.Context, id int64) (ep1 *emptypb.Empty, err error) {
