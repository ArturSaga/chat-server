...
//go:generate minimock -i github.com/ArturSaga/chat-server/internal/service.MessageService -o message_service_minimock.go -n MessageServiceMock -p mocks
...
// ExpectMessageParam2 sets up expected param message for MessageService.SendMessage
func (mmSendMessage *mMessageServiceMockSendMessage) ExpectMessageParam2(message *model.Message) *mMessageServiceMockSendMessage {
	if mmSendMessage.mock.funcSendMessage != nil {
		mmSendMessage.mock.t.Fatalf("MessageServiceMock.SendMessage mock is already set by Set")
	}
...
func (mmSendMessage *mMessageServiceMockSendMessage) Set(f func(ctx context.Context, message *model.Message) (ep1 *emptypb.Empty, err error)) *MessageServiceMock {
	if mmSendMessage.defaultExpectation != nil {
...
func (mmSendMessage *MessageServiceMock) SendMessage(ctx context.Context, message *model.Message) (ep1 *emptypb.Empty, err error) {
	...
	if mmSendMessage.SendMessageMock.defaultExpectation != nil {
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.message != nil && !minimock.Equal(*mm_want_ptrs.message, mm_got.message) {
				mmSendMessage.t.Errorf("MessageServiceMock.SendMessage got unexpected parameter message, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
