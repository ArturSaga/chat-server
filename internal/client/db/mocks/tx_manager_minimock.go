...
//go:generate minimock -i github.com/ArturSaga/chat-server/internal/client/db.TxManager -o tx_manager_minimock.go -n TxManagerMock -p mocks
...
import (
	...
	mm_db "github.com/ArturSaga/chat-server/internal/client/db"
