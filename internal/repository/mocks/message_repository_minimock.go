...
//go:generate minimock -i github.com/ArturSaga/chat-server/internal/repository.MessageRepository -o message_repository_minimock.go -n MessageRepositoryMock -p mocks
...
type MessageRepositoryMock struct {
	...
	funcSendMessage          func(ctx context.Context, messageInfo *model.Message) (ep1 *emptypb.Empty, err error)
	funcSendMessageOrigin    string
	inspectFuncSendMessage   func(ctx context.Context, messageInfo *model.Message)
...
func (mmSendMessage *mMessageRepositoryMockSendMessage) Expect(ctx context.Context, messageInfo *model.Message) *mMessageRepositoryMockSendMessage {
	...
	mmSendMessage.defaultExpectation.params = &MessageRepositoryMockSendMessageParams{ctx, messageInfo}
...
// ExpectMessageInfoParam2 sets up expected param messageInfo for MessageRepository.SendMessage
func (mmSendMessage *mMessageRepositoryMockSendMessage) ExpectMessageInfoParam2(messageInfo *model.Message) *mMessageRepositoryMockSendMessage {
	if mmSendMessage.mock.funcSendMessage != nil {
		mmSendMessage.mock.t.Fatalf("MessageRepositoryMock.SendMessage mock is already set by Set")
	}
	...
	mmSendMessage.defaultExpectation.paramPtrs.messageInfo = &messageInfo
	mmSendMessage.defaultExpectation.expectationOrigins.originMessageInfo = minimock.CallerInfo(1)

	return mmSendMessage
}

// Inspect accepts an inspector function that has same arguments as the MessageRepository.SendMessage
func (mmSendMessage *mMessageRepositoryMockSendMessage) Inspect(f func(ctx context.Context, messageInfo *model.Message)) *mMessageRepositoryMockSendMessage {
...
func (mmSendMessage *mMessageRepositoryMockSendMessage) Return(ep1 *emptypb.Empty, err error) *MessageRepositoryMock {
	if mmSendMessage.mock.funcSendMessage != nil {
		mmSendMessage.mock.t.Fatalf("MessageRepositoryMock.SendMessage mock is already set by Set")
	}
	...
	mmSendMessage.defaultExpectation.results = &MessageRepositoryMockSendMessageResults{ep1, err}
...
func (mmSendMessage *mMessageRepositoryMockSendMessage) Set(f func(ctx context.Context, messageInfo *model.Message) (ep1 *emptypb.Empty, err error)) *MessageRepositoryMock {
	if mmSendMessage.defaultExpectation != nil {
...
// Then helper
func (mmSendMessage *mMessageRepositoryMockSendMessage) When(ctx context.Context, messageInfo *model.Message) *MessageRepositoryMockSendMessageExpectation {
	if mmSendMessage.mock.funcSendMessage != nil {
		mmSendMessage.mock.t.Fatalf("MessageRepositoryMock.SendMessage mock is already set by Set")
	}
	...
	expectation := &MessageRepositoryMockSendMessageExpectation{
		...
		params:             &MessageRepositoryMockSendMessageParams{ctx, messageInfo},
...
func (e *MessageRepositoryMockSendMessageExpectation) Then(ep1 *emptypb.Empty, err error) *MessageRepositoryMock {
	e.results = &MessageRepositoryMockSendMessageResults{ep1, err}
	return e.mock
}
...
func (mmSendMessage *MessageRepositoryMock) SendMessage(ctx context.Context, messageInfo *model.Message) (ep1 *emptypb.Empty, err error) {
	...
	if mmSendMessage.inspectFuncSendMessage != nil {
		mmSendMessage.inspectFuncSendMessage(ctx, messageInfo)
	}

	mm_params := MessageRepositoryMockSendMessageParams{ctx, messageInfo}
	...
	if mmSendMessage.SendMessageMock.defaultExpectation != nil {
		...
		mm_got := MessageRepositoryMockSendMessageParams{ctx, messageInfo}
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.messageInfo != nil && !minimock.Equal(*mm_want_ptrs.messageInfo, mm_got.messageInfo) {
				mmSendMessage.t.Errorf("MessageRepositoryMock.SendMessage got unexpected parameter messageInfo, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
					mmSendMessage.SendMessageMock.defaultExpectation.expectationOrigins.originMessageInfo, *mm_want_ptrs.messageInfo, mm_got.messageInfo, minimock.Diff(*mm_want_ptrs.messageInfo, mm_got.messageInfo))
			}
	...
	if mmSendMessage.funcSendMessage != nil {
		return mmSendMessage.funcSendMessage(ctx, messageInfo)
	}
	mmSendMessage.t.Fatalf("Unexpected call to MessageRepositoryMock.SendMessage. %v %v", ctx, messageInfo)
	return
}
