...
//go:generate minimock -i github.com/ArturSaga/chat-server/internal/repository.ChatRepository -o chat_repository_minimock.go -n ChatRepositoryMock -p mocks
...
type ChatRepositoryMock struct {
	...
	funcDeleteChat          func(ctx context.Context, id int64) (ep1 *emptypb.Empty, err error)
...
func (mmDeleteChat *mChatRepositoryMockDeleteChat) Set(f func(ctx context.Context, id int64) (ep1 *emptypb.Empty, err error)) *ChatRepositoryMock {
	if mmDeleteChat.defaultExpectation != nil {
...
func (mmDeleteChat *ChatRepositoryMock) DeleteChat(ctx context.Context, id int64) (ep1 *emptypb.Empty, err error) {
